...
exports.Cam16 = exports.CorePalette = exports.ViewingConditions = exports.Blend = exports.Scheme = exports.TonalPalette = exports.Hct = exports.HctSolver = void 0;
exports.mathUtils_signum = mathUtils_signum;
exports.mathUtils_lerp = mathUtils_lerp;
exports.mathUtils_clampInt = mathUtils_clampInt;
exports.mathUtils_clampDouble = mathUtils_clampDouble;
exports.mathUtils_sanitizeDegreesInt = mathUtils_sanitizeDegreesInt;
exports.mathUtils_sanitizeDegreesDouble = mathUtils_sanitizeDegreesDouble;
exports.mathUtils_rotationDirection = mathUtils_rotationDirection;
exports.mathUtils_differenceDegrees = mathUtils_differenceDegrees;
exports.mathUtils_matrixMultiply = mathUtils_matrixMultiply;
 ...
 */
function mathUtils_lerp(start, stop, amount) {
 ...
 * otherwise.
 */
function mathUtils_clampInt(min, max, input) {
    if (input < min) {
        return min;
    }
    else if (input > max) {
 ...
 * otherwise.
 */
function mathUtils_clampDouble(min, max, input) {
    if (input < min) {
        return min;
    }
    else if (input > max) {
 ...
 * (exclusive).
 */
function mathUtils_sanitizeDegreesInt(degrees) {
    degrees = degrees % 360;
    if (degrees < 0) {
        degrees = degrees + 360;
    }
 ...
 * (exclusive).
 */
function mathUtils_sanitizeDegreesDouble(degrees) {
 ...
 * distance.
 */
function mathUtils_rotationDirection(from, to) {
 ...
 */
function mathUtils_differenceDegrees(a, b) {
    return 180.0 - Math.abs(Math.abs(a - b) - 180.0);
}
/**
 * Multiplies a 1x3 row vector with a 3x3 matrix.
 */
function mathUtils_matrixMultiply(row, matrix) {
...
class HctSolver {
    ...
    static findResultByJ(hueRadians, chroma, y) {
        ...
        for (let iterationRound = 0; iterationRound < 5; iterationRound++) {
            ...
            const linrgb = mathUtils_matrixMultiply([rCScaled, gCScaled, bCScaled], HctSolver.LINRGB_FROM_SCALED_DISCOUNT);
            // ===========================================================
            // Operations inlined from Cam16 to avoid repeated calculation
            // ===========================================================
...
class Blend {
    ...
    static harmonize(designColor, sourceColor) {
        ...
        const outputHue = mathUtils_sanitizeDegreesDouble(fromHct.hue + rotationDegrees * mathUtils_rotationDirection(fromHct.hue, toHct.hue));
...
function getColors(hex, dark) {
    const source = argbFromHex(hex);
    return dark ? Scheme.dark(source) : Scheme.light(source);
}
function getSchemeColors(input, dark) {
    let scheme = getColors(input, dark);
    return {
        colors: ([
            scheme.primary,
            scheme.onPrimary,
